...
// Ctrl+Scroll zoom
let zoomLevel=0;
document.addEventListener('wheel',e=>{if(e.ctrlKey){e.preventDefault();zoomLevel=Math.min(2,Math.max(-3,zoomLevel+(e.deltaY>0?-0.2:0.2)));webview?.setZoomLevel(zoomLevel);}},{passive:false});
