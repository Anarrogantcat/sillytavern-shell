...
const SKIP_DIRS=new Set(['node_modules','.git','backups','data','dist-electron','dist-electron-v3','dist-electron-lite','dist-electron-v3-lite','dist-electron-lite-tmp','src/electron','staging','.github','.vscode','.gemini','colab']);
