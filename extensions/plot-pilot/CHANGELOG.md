...
- **扩展信息卡改为折叠按钮**（参考「酒馆助手」信息卡的位置与样式）：面板底部只留一行 **ⓘ 扩展信息**，点一下才展开名称 / Ver / 查看日志 / 作者 / 许可 / 风险说明；展开状态记进设置（~~infoOpen~~）
### 说明
- 0.1.4 只改了署名，**不算功能更新**，已并入下面的 [0.1.3] 条目，不再单独占一个版本号

## [0.1.3] - 2026-09-20
### 变更
- **署名**：扩展信息块与 manifest 的作者改为 **小肥鱼（DeepSeek V4 Flash）· 染喵**（原为 sillytavern-shell）
### 新增
