...
function buildSettingsUi() {
    ...
    wrap.innerHTML = [
        ...
        '<label>「续写」按钮文字</label><input type="text" class="text_pole" id="pp-continue-label">',
        '<label>「续写」发送内容</label><input type="text" class="text_pole" id="pp-continue-text">',
        '<label>「推进节点」按钮文字</label><input type="text" class="text_pole" id="pp-advance-label">',
        ...
        '<label>本卡「续写」内容（留空 = 跟随全局）</label><input type="text" class="text_pole" id="pp-card-continue-text">',
        '<label>本卡「推进节点」内容（留空 = 跟随全局）</label><input type="text" class="text_pole" id="pp-card-advance-text">',
        '</fieldset>',
        ...
        '<div class="pp-info-line">作者：小肥鱼（DeepSeek V4 Flash）· 染喵 ｜ 许可：AGPL-3.0 ｜ 项目主页：<a href="' + REPO + '" target="_blank" rel="noopener">' + REPO + '</a></div>',
