...
function refreshTableButton() {
    try {
        ...
        const tg = tableWriteTarget();
        if (!tg) { bt.style.display = 'none'; return; }
        bt.textContent = T('varTableBtn') + '（' + tg.n + '）';
        bt.style.display = '';
    } catch (_) {}
}
